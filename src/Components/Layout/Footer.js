          ...
          >
            ...
            <nav className={styles["nav-col"]}>
              ...
              <ul className={styles["footer-nav"]}>
                <li>
                  <Link className={styles["footer-link"]} aria-label="Create Account"  to='/register'>
                    Create Account
                  </Link>
                </li>
                <li>
                  <Link className={styles["footer-link"]} aria-label="Sign in" to='/login'>
                    Sign in
                  </Link>
                </li>
                <li>
                  <Link className={styles["footer-link"]} aria-label="FAQ" to='/faq'>
                    FAQ
                  </Link>
                </li>
                <li>
                  <Link className={styles["footer-link"]} aria-label="Contact" to="/contact">
                    Contact
                  </Link>
                </li>
              </ul>
            ...
            <nav className={styles["nav-col"]}>
              ...
              <ul className={styles["footer-nav"]}>
                <li>
                  <Link className={styles["footer-link"]} aria-label="About US"  to='/about'>
                    About Us
                  </Link>
                </li>
                <li>
                  <Link className={styles["footer-link"]} aria-label="Shop" to='/shop'>
                    Shop
                  </Link>
                </li>
            ...
            <nav className={styles["nav-col"]}>
              ...
              <ul className={styles["footer-nav"]}>
                <li>
                  <Link className={styles["footer-link"]} aria-label="Help center" to='/help-center'>
                    Help center
                  </Link>
                </li>
                <li>
                  <Link className={styles["footer-link"]} aria-label="Privacy-terms" to='privacy-terms'>
                    Privacy & terms
                  </Link>
                </li>
              </ul>
